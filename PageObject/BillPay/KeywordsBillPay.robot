...
Dado que o usuário esteja na página de pagamento de contas
    ...
    Capturar Print Na Pasta Da Funcionalidade      QBEF-30 step-01                  PageObject/BillPay/Screenshots
...
Então deve mostrar uma mensagem de sucesso
    ...
    Capturar Print Na Pasta Da Funcionalidade      QBEF-30 step-03                 PageObject/BillPay/Screenshots
...
Então deve mostrar uma mensagem de erro com o nome vazio
    ...
    Capturar Print Na Pasta Da Funcionalidade      QBEF-31 step-03                 PageObject/BillPay/Screenshots
...
Então deve mostrar uma mensagem de erro com o endereço incompleto
    ...
    Capturar Print Na Pasta Da Funcionalidade      QBEF-32 step-03                 PageObject/BillPay/Screenshots
...
Então deve mostrar uma mensagem de erro com a cidade vazia
    ...
    Capturar Print Na Pasta Da Funcionalidade      QBEF-33 step-03                 PageObject/BillPay/Screenshots
...
Então deve mostrar uma mensagem de erro com o estado vazio
    ...
    Capturar Print Na Pasta Da Funcionalidade      QBEF-34 step-03                 PageObject/BillPay/Screenshots
...
Então deve mostrar uma mensagem de erro com o cep vazio
    ...
    Capturar Print Na Pasta Da Funcionalidade      QBEF-35 step-03                 PageObject/BillPay/Screenshots
...
Então deve mostrar uma mensagem de erro com o telefone vazio
    ...
    Capturar Print Na Pasta Da Funcionalidade      QBEF-36 step-03                 PageObject/BillPay/Screenshots
...
Então deve mostrar uma mensagem de erro com a quantidade vazia
    ...
    Capturar Print Na Pasta Da Funcionalidade      QBEF-37 step-03                 PageObject/BillPay/Screenshots
...
Então deve mostrar uma mensagem de erro com a conta vazia
    ...
    Capturar Print Na Pasta Da Funcionalidade      QBEF-38 step-03                 PageObject/BillPay/Screenshots
...
Então deve mostrar uma mensagem de erro com a verificar conta vazia
    ...
    Capturar Print Na Pasta Da Funcionalidade      QBEF-39 step-03                 PageObject/BillPay/Screenshots
...
E preencher os campos de pagamento com os dados completos
    ...
    Capturar Print Na Pasta Da Funcionalidade      QBEF-30 step-02     PageObject/BillPay/Screenshots
...
E preencher os campos de pagamento com o dado de nome vazio
    ...
    Input Text     ${CAMPO_VERIFICAR_CONTA}        ${verificar_conta}
    Input Text     ${CAMPO_QUANTIDADE}             ${quantidade}
    Capturar Print Na Pasta Da Funcionalidade      QBEF-31 step-02     PageObject/BillPay/Screenshots
...
E preencher os campos de pagamento com o dado de endereço incompleto
    ...
    Input Text     ${CAMPO_VERIFICAR_CONTA}        ${verificar_conta}
    Input Text     ${CAMPO_QUANTIDADE}             ${quantidade}
    Capturar Print Na Pasta Da Funcionalidade      QBEF-32 step-02     PageObject/BillPay/Screenshots
...
E preencher os campos de pagamento com o dado de cidade vazio
    ...
    Input Text     ${CAMPO_VERIFICAR_CONTA}        ${verificar_conta}
    Input Text     ${CAMPO_QUANTIDADE}             ${quantidade}
    Capturar Print Na Pasta Da Funcionalidade      QBEF-33 step-02     PageObject/BillPay/Screenshots
...
E preencher os campos de pagamento com o dado de estado vazio
    ...
    Input Text     ${CAMPO_VERIFICAR_CONTA}        ${verificar_conta}
    Input Text     ${CAMPO_QUANTIDADE}             ${quantidade}
    Capturar Print Na Pasta Da Funcionalidade      QBEF-34 step-02     PageObject/BillPay/Screenshots
...
E preencher os campos de pagamento com o dado de cep vazio
    ...
    Input Text     ${CAMPO_VERIFICAR_CONTA}        ${verificar_conta}
    Input Text     ${CAMPO_QUANTIDADE}             ${quantidade}
    Capturar Print Na Pasta Da Funcionalidade      QBEF-35 step-02     PageObject/BillPay/Screenshots
...
E preencher os campos de pagamento com o dado de telefone vazio
    ...
    Input Text     ${CAMPO_VERIFICAR_CONTA}        ${verificar_conta}
    Input Text     ${CAMPO_QUANTIDADE}             ${quantidade}
    Capturar Print Na Pasta Da Funcionalidade      QBEF-36 step-02     PageObject/BillPay/Screenshots
...
E preencher os campos de pagamento com o dado de conta vazio
    ...
    Input Text     ${CAMPO_VERIFICAR_CONTA}        ${verificar_conta}
    Input Text     ${CAMPO_QUANTIDADE}             ${quantidade}
    Capturar Print Na Pasta Da Funcionalidade      QBEF-37 step-02     PageObject/BillPay/Screenshots
...
E preencher os campos de pagamento com o dado de verificar conta vazio
    ...
    Input Text     ${CAMPO_VERIFICAR_CONTA}        ${verificar_conta}
    Input Text     ${CAMPO_QUANTIDADE}             ${quantidade}
    Capturar Print Na Pasta Da Funcionalidade      QBEF-38 step-02     PageObject/BillPay/Screenshots
...
E preencher os campos de pagamento com o dado de quantidade vazio
    ...
    Input Text     ${CAMPO_VERIFICAR_CONTA}        ${verificar_conta}
    Input Text     ${CAMPO_QUANTIDADE}             ${quantidade}
    Capturar Print Na Pasta Da Funcionalidade      QBEF-39 step-02     PageObject/BillPay/Screenshots