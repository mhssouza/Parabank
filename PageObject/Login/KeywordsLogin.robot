...
Dado que o usuário esteja na tela de Login
    ...
    Capturar Print Na Pasta Da Funcionalidade    QBEF-01-step-01    PageObject/Login/Screenshots
...
Então deve ser redirecionado para a página inicial
    ...
    Capturar Print Na Pasta Da Funcionalidade      QBEF-01-step-03     PageObject/Login/Screenshots
...
Então deve ver uma mensagem de erro de login
    ...
    Capturar Print Na Pasta Da Funcionalidade      QBEF-02-step-03     PageObject/Login/Screenshots

Então deve ver uma mensagem de erro de campos vazios
    Wait Until Element Is Visible    ${MENSAGEM_ERRO1}         10s
    Element Should Be Enabled        ${MENSAGEM_ERRO1}
    Capturar Print Na Pasta Da Funcionalidade      QBEF-03-step-03     PageObject/Login/Screenshots